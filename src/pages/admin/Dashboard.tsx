...
const Dashboard = () => {
  ...
  const { orders, totalOrders, totalRevenue, totalCustomers, totalProducts } = useDashboardData();
    ...
    <AdminLayout>
      <div className="space-y-8">
        ...
        <div className="text-center space-y-4 mb-12">
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-food-primary via-accent to-food-primary bg-clip-text text-transparent">
            Dashboard
          </h1>
